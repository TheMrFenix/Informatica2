...
public class SeguridadTierra extends Seguridad{
    ...
    private int annosExperiencia_Seg; // nn es ñ en italiano
    public SeguridadTierra() {
    }
    ...
    public String toString() {
        return "Seguridad en Area de Tierra{" +
